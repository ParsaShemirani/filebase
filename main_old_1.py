...
class ChildFilesViewer(DataTable):
    BINDINGS = [("k", "cursor_up", "Cursor Up"), ("j", "cursor_down", "Cursor Down"), ("space", "select_cursor", "Select Cursor"), ("d", "deselect_all", "Deselect All")]
    ...
    def on_mount(self):
        ...
        self.add_columns(("Selected", "selected_col"), ("Name", "name_col"))
    ...
    def watch_selected_directory_file_ids(self, old_list, new_list) -> None:
        for 
...
class ChildDirectoriesViewer(DataTable):
    ...
    def watch_current_dir_id(self, value):
        ...
        for child_directory in child_directories:
            self.add_row(child_directory.name, key=child_directory.id)
